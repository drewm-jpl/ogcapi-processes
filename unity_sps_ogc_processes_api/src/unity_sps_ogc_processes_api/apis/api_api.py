...
@router.get(
    ...
    responses={
        ...
        406: {"model": Exception, "description": "Content negotiation failed. For example, the &#x60;Accept&#x60; header submitted in the request did not support any of the media types supported by the server for the requested resource."},
...
async def get_api(
    f: str = Query(None, description="The format of the response. If no value is provided, the accept header is used to determine the format. Accepted values are &#39;json&#39; or &#39;html&#39;.", alias="f"),
) -> object:
    ...
...
@router.get(
    "/api/processes-list",
    responses={
        200: {"model": Enumeration, "description": "An enumerated list of valid string values for API parameters."},
