...
class SchemaOneOf(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "allOf": [Schema1.from_dict(_item) for _item in obj.get("allOf")] if obj.get("allOf") is not None else None,
            "oneOf": [Schema1.from_dict(_item) for _item in obj.get("oneOf")] if obj.get("oneOf") is not None else None,
            "anyOf": [Schema1.from_dict(_item) for _item in obj.get("anyOf")] if obj.get("anyOf") is not None else None,
            ...
            "additionalProperties": SchemaOneOfAdditionalProperties.from_dict(obj.get("additionalProperties")) if obj.get("additionalProperties") is not None else None,
