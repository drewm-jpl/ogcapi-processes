...
from unity_sps_ogc_processes_api.models.input_value1 import InputValue1
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class QualifiedInputValue1(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of QualifiedInputValue1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of QualifiedInputValue1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "value": InputValue1.from_dict(obj.get("value")) if obj.get("value") is not None else None
        })
        return _obj
